/*
 * Source: TrxFormFullCaller.java - Generated by OBCOM SQL Wizard 5.1.295
...
/**
 * Implements a caller of procedure "PKG_CUT_SERVICES_TRX.TRX_FORM_FULL".
 * <pre>
 ...
 * </pre>
 */
public class TrxFormFullCaller extends ProcedureCaller
{
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.TRX_FORM_FULL" using a DataSource.
     */
    public static TrxFormFullResult execute(DataSource dataSource, String inUser, BigDecimal inRutIra, String inRutIraDv, BigDecimal inFormTipo, String inFormVer, String inItems, String inIdOrigen, String inPaquete, String inRuta, BigDecimal inFolioF01, Date inFechaOrigen, Date inFechaCaja, BigDecimal inLoteId, BigDecimal inLoteCanal, BigDecimal inLoteTipo, BigDecimal inCutMovEstado, String inEsReversa, BigDecimal inMovIdAnular, String inFrmOpcion, String inFmtDataErr, String inFmtDataSal, String inMotivo, String inResolucion)
        throws SQLException
    {
        Connection conn = dataSource.getConnection();
        try {
            return execute(conn, inUser, inRutIra, inRutIraDv, inFormTipo, inFormVer, inItems, inIdOrigen, inPaquete, inRuta, inFolioF01, inFechaOrigen, inFechaCaja, inLoteId, inLoteCanal, inLoteTipo, inCutMovEstado, inEsReversa, inMovIdAnular, inFrmOpcion, inFmtDataErr, inFmtDataSal, inMotivo, inResolucion);
        } finally {
            conn.close();
        }
    }
    ...
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.TRX_FORM_FULL" using a Connection.
     */
    public static TrxFormFullResult execute(Connection conn, String inUser, BigDecimal inRutIra, String inRutIraDv, BigDecimal inFormTipo, String inFormVer, String inItems, String inIdOrigen, String inPaquete, String inRuta, BigDecimal inFolioF01, Date inFechaOrigen, Date inFechaCaja, BigDecimal inLoteId, BigDecimal inLoteCanal, BigDecimal inLoteTipo, BigDecimal inCutMovEstado, String inEsReversa, BigDecimal inMovIdAnular, String inFrmOpcion, String inFmtDataErr, String inFmtDataSal, String inMotivo, String inResolucion)
        throws SQLException
    {
        TrxFormFullResult result = new TrxFormFullResult();
        ArrayList resultSets = new ArrayList();
        if (conn.getMetaData().getURL().startsWith("jdbc:oracle:")) {
            CallableStatement call = conn.prepareCall("{call PKG_CUT_SERVICES_TRX.TRX_FORM_FULL(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
            try {
                ...
                call.registerOutParameter(24, Types.NUMERIC);
                ...
                call.registerOutParameter(28, ORACLE_CURSOR);
                call.execute();
                result.setOutErrlvl(call.getBigDecimal(24));
                result.setOutMensajes(call.getString(25));
                result.setOutTrnTranId(call.getString(26));
                result.setOutCutMovId(call.getString(27));
                resultSets.add(toRowSet((ResultSet)call.getObject(28)));
            } finally {
                call.close();
            }
        } else {
