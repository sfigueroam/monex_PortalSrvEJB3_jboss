...
/**
 * Output parameters of procedure "PKG_CUT_SERVICES_TRX.SIST_RET_PORC_CONDONA".
 */
public class SistRetPorcCondonaResult extends ProcedureResult
{
    private static final long serialVersionUID = 1L;
    private String retornaPorc;    
    private RowSet[] rowSets;

    /**
     * Constructor.
     */
    public SistRetPorcCondonaResult()
    {
        super();
    }

    /**
     * Returns the value of "retornaSN".
     */
    public String getRetornaPorc()
    {
        return retornaPorc;
    }

    /**
     * Changes the value of "retornaSN".
     */
    public void setRetornaPorc(String retornaPorc)
    {
        this.retornaPorc = retornaPorc;
    }
