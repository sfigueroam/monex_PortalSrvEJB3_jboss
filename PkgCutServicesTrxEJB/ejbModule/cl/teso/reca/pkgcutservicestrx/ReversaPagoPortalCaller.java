/*
 * Source: ReversaPagoPortalCaller.java - Generated by OBCOM SQL Wizard 5.1.295
...
/**
 * Implements a caller of procedure "PKG_CUT_SERVICES_TRX.REVERSA_PAGO_PORTAL".
 * <pre>
 ...
 * </pre>
 */
public class ReversaPagoPortalCaller extends ProcedureCaller
{
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.REVERSA_PAGO_PORTAL" using a DataSource.
     */
    public static ReversaPagoPortalResult execute(DataSource dataSource, String inUser, String inCodTransac, Date inFechaOrigen, String inCodigoBarra, BigDecimal inMonedaPago, BigDecimal inValorCambio, BigDecimal inMontoPago, BigDecimal inIdOperacion, BigDecimal inIdTransaccion, Date inFechaPago, String inAutCodigo, BigDecimal inRutIra, BigDecimal inLoteCanal, BigDecimal inLoteTipo, BigDecimal inIdOperacion698, BigDecimal inIdTransac698, BigDecimal inIdMonto698, BigDecimal inIdDeudas698, BigDecimal inFolioF01, String inFrmOpcion, String inFmtDataErr, String inEnviaTrnSaf)
        throws SQLException
    {
    ...
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.REVERSA_PAGO_PORTAL" using a Connection.
     */
    public static ReversaPagoPortalResult execute(Connection conn, String inUser, String inCodTransac, Date inFechaOrigen, String inCodigoBarra, BigDecimal inMonedaPago, BigDecimal inValorCambio, BigDecimal inMontoPago, BigDecimal inIdOperacion, BigDecimal inIdTransaccion, Date inFechaPago, String inAutCodigo, BigDecimal inRutIra, BigDecimal inLoteCanal, BigDecimal inLoteTipo, BigDecimal inIdOperacion698, BigDecimal inIdTransac698, BigDecimal inIdMonto698, BigDecimal inIdDeudas698, BigDecimal inFolioF01, String inFrmOpcion, String inFmtDataErr, String inEnviaTrnSaf)
        throws SQLException
    {
        ReversaPagoPortalResult result = new ReversaPagoPortalResult();
        ArrayList resultSets = new ArrayList();
        if (conn.getMetaData().getURL().startsWith("jdbc:oracle:")) {
            CallableStatement call = conn.prepareCall("{call PKG_CUT_SERVICES_TRX.REVERSA_PAGO_PORTAL(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
            try {
