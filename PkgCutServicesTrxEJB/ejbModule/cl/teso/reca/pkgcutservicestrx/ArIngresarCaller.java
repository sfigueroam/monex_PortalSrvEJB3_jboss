/*
 * Source: ArIngresarCaller.java - Generated by OBCOM SQL Wizard 5.1.295
...
/**
 * Implements a caller of procedure "PKG_CUT_SERVICES_TRX.AR_INGRESAR".
 * <pre>
...
{
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.AR_INGRESAR" using a DataSource.
     */
    ...
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.AR_INGRESAR" using a Connection.
     */
        ...
        throws SQLException
    {
        ...
        CallableStatement call = conn.prepareCall("{call PKG_CUT_SERVICES_TRX.AR_INGRESAR(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
        try {
