/*
 * Source: TrxFormFullFcResult.java - Generated by OBCOM SQL Wizard 5.1.295
...
/**
 * Output parameters of procedure "PKG_CUT_SERVICES_TRX.TRX_FORM_FULL_FC".
 */
public class TrxFormFullFcResult extends ProcedureResult
{
    private static final long serialVersionUID = 1L;
    private BigDecimal outErrlvl;
    private String outMensajes;
    private String outTrnTranId;
    private String outCutMovId;
    ...
    /**
     * Returns the value of "OutTrnTranId".
     */
    public String getOutTrnTranId()
    {
        return outTrnTranId;
    }

    /**
     * Changes the value of "OutTrnTranId".
     */
    public void setOutTrnTranId(String outTrnTranId)
    {
        this.outTrnTranId = outTrnTranId;
    }

    /**
     * Returns the value of "OutCutMovId".
     */
    public String getOutCutMovId()
    {
        return outCutMovId;
    }

    /**
     * Changes the value of "OutCutMovId".
     */
    public void setOutCutMovId(String outCutMovId)
    {
        this.outCutMovId = outCutMovId;
    }
