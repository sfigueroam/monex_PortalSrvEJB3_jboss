/*
 * Source: GrabaLogTransaccionCaller.java - Generated by OBCOM SQL Wizard 5.1.295
...
/**
 * Implements a caller of procedure "PKG_CUT_SERVICES_TRX.GRABA_LOG_TRANSACCION".
 * <pre>
...
{
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.GRABA_LOG_TRANSACCION" using a DataSource.
     */
    ...
    /**
     * Executes procedure "PKG_CUT_SERVICES_TRX.GRABA_LOG_TRANSACCION" using a Connection.
     */
        ...
        throws SQLException
    {
        ...
        CallableStatement call = conn.prepareCall("{call PKG_CUT_SERVICES_TRX.GRABA_LOG_TRANSACCION(?,?,?,?,?,?,?,?,?,?,?)}");
        try {
