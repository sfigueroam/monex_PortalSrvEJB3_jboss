/*
 * File: GetFrmIdSafeCaller.java  2009-07-15 17:54:49-04:00
 * User: Felipe Gonzalez (DP S.A.)
 *
 * File generated by OBCOM SQL Wizard 5.1.248 (www.obcom.cl).
 * DO NOT EDIT THIS FILE <<Signature:C-4FrPr5Awb4KlW744Z4wZ>>.
 */
...
/**
 * Implements a caller of procedure "PKG_CAJA_SERVICES.GET_FRM_ID_SAFE".
 *
...
{
    /**
     * Executes procedure "PKG_CAJA_SERVICES.GET_FRM_ID_SAFE" using a DataSource.
     */
    ...
    /**
     * Executes procedure "PKG_CAJA_SERVICES.GET_FRM_ID_SAFE" using a Connection.
     */
        ...
        throws SQLException
    {
        ...
        CallableStatement call = conn.prepareCall("{?=call PKG_CAJA_SERVICES.GET_FRM_ID_SAFE(?,?,?)}");
        try
        {
